    ...
    class Enemy:
        ...
        def draw(self, screen, scroll):
            ...
            pygame.draw.rect(screen, ENEMY_COLOR,
                             (self.rect.x - scroll, self.rect.y, self.rect.width, self.rect.height), border_radius=8)

            # Draw enemy eyes
            eye_offset = 5 if self.direction == 1 else -5
            pygame.draw.circle(screen, (0, 0, 0), (
            int(self.rect.x - scroll + self.rect.width // 2 - 5 + eye_offset // 2), int(self.rect.y + 15)), 4)
            pygame.draw.circle(screen, (0, 0, 0), (
            int(self.rect.x - scroll + self.rect.width // 2 + 5 + eye_offset // 2), int(self.rect.y + 15)), 4)
            ...
            pygame.draw.rect(screen, ENEMY_COLOR,
                             (self.rect.x - scroll + self.rect.width - 10, leg_y - leg_offset, 5, 10))
